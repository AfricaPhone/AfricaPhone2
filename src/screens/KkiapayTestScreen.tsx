...
const KkiapayTestScreen = () => {
  ...
  useEffect(() => {
    const successSubscription = addSuccessListener(data => {
    ...
    const failedSubscription = addFailedListener(error => {
  ...
  const handlePayment = () => {
    ...
    openKkiapayWidget({
      ...
      api_key: 'VOTRE_CLÉ_PUBLIQUE_SANDBOX_ICI', // IMPORTANT: Remplacez par votre clé publique de test
      sandbox: true,
