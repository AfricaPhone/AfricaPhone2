...
/**
 * Backfill script to recover the 87 lost votes for votes-artistes contest.
 * 
 * This script:
 * 1. Reads the lost votes from the exported JSON
 * 2. For each lost vote, creates the missing vote document
 * 3. Increments candidate.voteCount and contest.totalVotes
 * 4. Marks the voteIntent as 'counted'
 * 5. Creates/updates the payment document with status 'success'
 * 
 * Safety:
 * - Idempotent: skips already counted votes
 * - Uses DRY_RUN=1 to preview without writing
 */
