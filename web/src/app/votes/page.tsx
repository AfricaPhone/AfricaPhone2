  ...
  return (
    <div className="min-h-screen bg-[#F6F7F9] text-[#111827]">
      ...
      <main className="mx-auto flex w-full max-w-screen-sm flex-col gap-5 px-4 pb-16 pt-5">
        ...
        <CandidateSearchBar value={searchQuery} onChange={setSearchQuery} disabled={isBusy} />
...
function CandidateSearchBar({ value, onChange, disabled = false }: CandidateSearchBarProps) {
  return (
    <div className="flex w-full items-center overflow-hidden rounded-full border border-slate-200 bg-white px-4 py-2 shadow-sm shadow-slate-200/50 focus-within:border-orange-400 focus-within:ring-2 focus-within:ring-orange-100">
